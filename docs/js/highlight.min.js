  ...
  var ne = ((n) => {
    ...
    function f(e, n, i, r) {
      ...
      function y(a, r) {
        ...
        if (
          "begin" === h.type && "end" === r.type && h.index === r.index &&
          "" === o
        ) {
  ...
  var ce = "\\.([0-9](_*[0-9])*)",
    ...
    ge = {
      ...
      variants: [
        {
          begin:
            `(\\b([0-9](_*[0-9])*)((${ce})|\\.)?|(${ce}))[eE][+-]?([0-9](_*[0-9])*)[fFdD]?\\b`,
        },
        ...
        {
          begin:
            `\\b0[xX]((${de})\\.?|(${de})?\\.(${de}))[pP][+-]?([0-9](_*[0-9])*)[fFdD]?\\b`,
        },
  ...
  var Ue = Object.freeze({
    ...
    grmr_c: (e) => {
      const n = e.regex,
        ...
        a = "[a-zA-Z_]\\w*::",
        i = "(decltype\\(auto\\)|" + n.optional(a) + "[a-zA-Z_]\\w*" +
          n.optional("<[^<>]+>") + ")",
        r = {
          className: "type",
    ...
    grmr_cpp: (e) => {
      const n = e.regex,
        ...
        a = "[a-zA-Z_]\\w*::",
        i = "(?!struct)(decltype\\(auto\\)|" + n.optional(a) + "[a-zA-Z_]\\w*" +
          n.optional("<[^<>]+>") + ")",
        r = {
          className: "type",
          begin: "\\b[a-z\\d_]*_t\\b",
      ...
      const n = { match: /\s+/, relevance: 0 },
        ...
        o = {
          variants: [{
            className: "keyword",
            match: p(
              ...xe.filter((e) => "string" != typeof e).concat(ke).map(Ne),
              ...Oe,
            ),
          }],
        },
